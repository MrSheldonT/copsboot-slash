...
import com.slash.copsboot.infrastructure.test.CopsbootControllerTest;
...
public class ReportRestControllerTest {
    ...
    public void officerIsAbleToPostAReport() throws Exception {
        ...
        AuthServerId authServerId = new AuthServerId(UUID.fromString("eaa8b8a5-a264-48be98de-d8b4ae2750ac"));
        ...
        mockMvc.perform(post("/api/reports")
                ...
                .andExpect(jsonPath("description").value("This is a test reportdescription."));
    }
}